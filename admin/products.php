...
$pr = new Product;
$prods = $pr->selectAllWithCats("products.id AS prodId , products.name AS prodName , cats.name AS catName , img , pieces_no , price , products.created_at AS prodCreatedAt ");
